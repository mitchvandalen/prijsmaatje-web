...
export default function RegisterInner() {
  ...
  const loginHref = `/login${nextQuery ? `?next=${encodeURIComponent(nextQuery)}` : ""}`;
    ...
    <div className="pm-page">
      <div className="pm-header">
        ...
        <div className="pm-subtitle">
          Maak een account aan voor geschiedenis, vaste lijstjes en Premium.
        </div>
      </div>
      ...
      <div style={{ maxWidth: 520 }}>
        <div className="pm-card">
          ...
          <form onSubmit={onSubmit} style={{ display: "grid", gap: 14 }}>
            ...
            <label style={{ display: "grid", gap: 6 }}>
              ...
              <div className="pm-caption">
                Tip: minimaal 8 tekens is slim (en gebruik hoofdletters/cijfers).
              </div>
            </label>
          ...
          <div className="pm-caption" style={{ marginTop: 14 }}>
            ...
            <Link href={loginHref} style={{ color: "var(--pm-indigo)", fontWeight: 700 }}>
              Inloggen
            </Link>
          </div>
        </div>
